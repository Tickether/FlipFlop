...
import { Hex, Signature, parseUnits } from "viem";
...
export default function DepositModalUSDC({ connectedAddress, publicClient }: any) {
      ...
      {showContinue ? (
        ...
        <button
          ...
          onClick={() => confirmRoute({
            ...
            args: [parseUnits(dstDisplay!, 6), connectedAddress],
            connectedAddress,
            continueDisabled,
            setSubmitting,
            setShowContinue,
